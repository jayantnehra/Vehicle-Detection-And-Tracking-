...
if __name__ == "__main__":
    ...
    if demo == 1:
        filename = 'examples/test_images/images/frame_0094.jpg'
        ...
        fig = plt.figure()
        plt.imshow(draw_img)
        plt.savefig('frame_0100.jpg', format='jpg')
	...
	#clip1 = VideoFileClip("examples/project_video.mp4").subclip(00,50)
        clip1 = VideoFileClip("examples/project_video.mp4").subclip(30,40)
        clip = clip1.fl_image(pipeline_yolo)
        clip.write_videofile(video_output, audio=False)

    else:
        # SVM pipeline
        video_output = 'examples/project_svm_final.mp4'
        clip1 = VideoFileClip("examples/project_video.mp4")#.subclip(20,35)
